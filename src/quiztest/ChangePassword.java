    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        else
        {
            try
            {
                ...
                String sql1 = "select * from student where emailid='"+emailid+"' and password='"+currentpassword+"' ";
                ResultSet rs = st.executeQuery(sql1);
                if(rs.next())
                {
                    String sql2 = "update student set password='"+newpassword+"' where emailid='"+emailid+"'";
